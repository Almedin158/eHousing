        ...
        partial void OnModelCreatingPartial(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Estate>().HasData(
                new Estate { 
                    ...
                    StreetId=1,
                    EstateTypeId=2,
                    EstateName= "Dvosoban stan Sarajevo",
                    PetsAllowed=true,
                ...
                new Estate
                {
                    ...
                    StreetId = 1,
                    EstateTypeId = 2,
                    EstateName = "Jednosoban stan Sarajevo Grbavica",
                    PetsAllowed = false,
                    CreationDate = DateTime.Now,
                    EstateDescription = "Description",
                    FloorSpace = 80,
                ...
                new Estate
                {
                    ...
                    StreetId = 1,
                    EstateTypeId = 1,
                    EstateName = "Sarajevo, garsonjera, Skenderija",
                    PetsAllowed = true,
                    CreationDate = DateTime.Now,
                    EstateDescription = "Description",
                    FloorSpace = 80,
                ...
                new Estate
                {
                    ...
                    StreetId = 1,
                    EstateTypeId = 1,
                    EstateName = "Sarajevo jednosoban stan Buce potok",
                    PetsAllowed = false,
                    CreationDate = DateTime.Now,
                    EstateDescription = "Description",
                    FloorSpace = 80,
                ...
                new Estate
                {
                    ...
                    StreetId = 1,
                    EstateTypeId = 3,
                    EstateName = "Sarajevo Pofalici trosoban stan",
                    PetsAllowed = false,
                    CreationDate = DateTime.Now,
                    EstateDescription = "Description",
                    FloorSpace = 80,
                ...
                new Estate
                {
                    ...
                    StreetId = 2,
                    EstateTypeId = 2,
                    EstateName = "Sarajevo Marsala Tita, dvosoban stan za troje",
                    PetsAllowed = false,
                    CreationDate = DateTime.Now,
                    EstateDescription = "Description",
                    FloorSpace = 80,
                ...
                new Estate
                {
                    ...
                    StreetId = 3,
                    EstateTypeId = 3,
                    EstateName = "Sarajevo Adema Buce Stan za rent",
                    PetsAllowed = false,
                    CreationDate = DateTime.Now,
                    EstateDescription = "Description",
                    FloorSpace = 80,
                ...
                new Estate
                {
                    ...
                    StreetId = 4,
                    EstateTypeId = 2,
                    EstateName = "Sarajevo Stup garsonjera",
                    PetsAllowed = false,
                    CreationDate = DateTime.Now,
                    EstateDescription = "Description",
                    FloorSpace = 80,
